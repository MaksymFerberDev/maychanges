...
export const teamData: TTeamData[] = [
  {
    ...
    modal: {
      short_description: 'Jules founded Industrial Succession with the goal of leveraging years of experience in sales, manufacturing, and engineering in order to acquire and grow established manufacturing operations. He blends a passion for creative engineering solutions with a love for well branded and marketed products.',
      description: [
  ...
  },
  {
    ...
    modal: {
      short_description: 'As an Director of Finance and M&A, Kenneth’s responsibilities include supporting the strategic initiatives of portfolio companies, evaluating investment opportunities, and assisting in the deal execution and diligence of new investments.',
      description: [
  ...
  },
  {
    ...
    modal: {
      short_description: 'Ted is a senior executive with more than 35 years of experience in the metals production, distribution, fabrication, and finishing segment. He has a proven track record of partnering with a variety of stakeholders, including boards of directors, investors, and lenders.',
      description: [
